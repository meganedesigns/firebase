...
export declare enum NotificationAndroidVisibility {
...
export interface Notification {
    ...
    ios?: undefined | {
        ...
        subtitleLocKey: undefined | string;
    };
...
export declare enum NotificationAndroidPriority {
    PRIORITY_DEFAULT = 0,
    PRIORITY_HIGH = 1,
    PRIORITY_LOW = 2,
    PRIORITY_MAX = 3,
...
export interface IMessaging {
    ...
    onMessage(listener: (message: RemoteMessage) => any): any;
    onNotificationTap(listener: (message: RemoteMessage) => any): any;
    onToken(listener: (token: string) => any): any;
