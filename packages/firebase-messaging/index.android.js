...
function ensureCallback() {
	var CallbackImpl = /** @class */ (function (_super) {
		...
		CallbackImpl = __decorate([Interfaces([org.nativescript.firebase.messaging.FirebaseMessaging.Callback])], CallbackImpl);
		return CallbackImpl;
	})(java.lang.Object);
	...
	getToken() {
		return new Promise((resolve, reject) => {
			org.nativescript.firebase.messaging.FirebaseMessaging.getToken(
				this.native,
				new org.nativescript.firebase.messaging.FirebaseMessaging.Callback({
					onSuccess(result) {
						resolve(result);
					},
					onError(error) {
