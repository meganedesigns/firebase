...
_FirebaseOptions_nativeApp = new WeakMap(), _FirebaseOptions_apiKey = new WeakMap(), _FirebaseOptions_gcmSenderId = new WeakMap(), _FirebaseOptions_androidClientId = new WeakMap(), _FirebaseOptions_appGroupId = new WeakMap(), _FirebaseOptions_bundleId = new WeakMap(), _FirebaseOptions_clientId = new WeakMap(), _FirebaseOptions_databaseURL = new WeakMap(), _FirebaseOptions_deepLinkURLScheme = new WeakMap(), _FirebaseOptions_googleAppId = new WeakMap(), _FirebaseOptions_projectId = new WeakMap(), _FirebaseOptions_storageBucket = new WeakMap(), _FirebaseOptions_trackingId = new WeakMap();
